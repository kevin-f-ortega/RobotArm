...
#include <RobotArm/Top/RobotArmTopology.hpp>
...
int main(int argc, char* argv[]) {
    ...
    RobotArm::setupTopology(inputs);
    RobotArm::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    RobotArm::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
