// ======================================================================
// \title  RobotArmTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef ROBOTARM_ROBOTARMTOPOLOGY_HPP
#define ROBOTARM_ROBOTARMTOPOLOGY_HPP
// Included for access to RobotArm::TopologyState and RobotArm::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <RobotArm/Top/RobotArmTopologyDefs.hpp>

// Remove unnecessary RobotArm:: qualifications
 ...
 * RobotArm::TopologyState see: RobotArmTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type RobotArm::TopologyState see: RobotArmTopologyDefs.hpp.
 *
