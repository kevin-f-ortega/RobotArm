// ======================================================================
// \title  RobotArmTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef ROBOTARM_ROBOTARMTOPOLOGYDEFS_HPP
#define ROBOTARM_ROBOTARMTOPOLOGYDEFS_HPP

#include "Drv/BlockDriver/BlockDriver.hpp"
#include "Fw/Types/MallocAllocator.hpp"
#include "RobotArm/Top/FppConstantsAc.hpp"
 ...
 *
 * The topology autocoder requires an object that carries state with the name `RobotArm::TopologyState`. Only the type
