...
void Tester ::from_i2c_handler(const NATIVE_INT_TYPE portNum, U32 addr, Fw::Buffer& serBuffer) {
...
void Tester ::connectPorts(void) {
    // position
    this->connect_to_position(0, this->component.get_position_InputPort(0));

    // CmdDisp
    this->connect_to_CmdDisp(0, this->component.get_CmdDisp_InputPort(0));

    // i2c
    this->component.set_i2c_OutputPort(0, this->get_from_i2c(0));
