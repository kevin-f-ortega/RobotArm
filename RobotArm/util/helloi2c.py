...
OFFSET = 0
START_ADDR = 0x06 + OFFSET
STOP_ADDR = 0x08 + OFFSET
...
bus.write_word_data(addr, START_ADDR, 0)     # chl 0 start time = 0us
bus.write_word_data(addr, STOP_ADDR, 1250)  # chl 0 end time = 1.5ms
...
bus.write_word_data(addr, STOP_ADDR, 836)  # chl 0 end time = 1.0ms
time.sleep(2)
bus.write_word_data(addr, STOP_ADDR, 1664)  # chl 0 end time = 2.0ms
time.sleep(2)
bus.write_word_data(addr, STOP_ADDR, 1250)  # chl 0 end time = 1.5ms
